...
function backKillTime(weapon,ammo,type){
    ...
    if(type === 'Head'){
        ...
        damageTaken = (sumHealth - damageHealth)/(sumHealth/100);
        dmg = damageTaken;
    }
    else if(type === 'Limb'){
    ...
    return (shootOnSecond * dmg).toFixed(3);
}
...
function refreshStats(){
    weaponChooseList.forEach(element =>{
        if(element.Stats === null){
            ...
            newChild.children[2].children[4].textContent = backKillTime(element.Item,element.Ammo);
            newChild.children[2].children[3].textContent = backKillTime(element.Item,element.Ammo,'Head');
            ...
            element.Stats.children[2].children[4].textContent = backKillTime(element.Item,element.Ammo);
            element.Stats.children[2].children[3].textContent = backKillTime(element.Item,element.Ammo, 'Head');
        }
    });
}
